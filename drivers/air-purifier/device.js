...
const checkAndRegisterFanParameters_1 = __importDefault(require("../../utilites/homey_device_hooks/checkAndRegisterFanParameters"));
class PurifierDevice extends homey_1.default.Device {
    async onInit() {
        ...
        await (0, checkAndRegisterFanParameters_1.default)(this, 'speed', IP, path);
        /**
