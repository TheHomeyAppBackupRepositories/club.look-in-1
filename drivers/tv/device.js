...
const checkAndRegisterModeListener_1 = __importDefault(require("../../utilites/homey_device_hooks/checkAndRegisterModeListener"));
class TVDevice extends homey_1.default.Device {
    async onInit() {
        ...
        await (0, checkAndRegisterModeListener_1.default)(this, IP, UUID, path);
        /**
        ...
        this.registerCapabilityListener('channel_up', async () => {
            await (0, sendRequest_1.default)(this, '08FF', 'chup', 'channel up', IP, path);
        });
        this.registerCapabilityListener('channel_down', async () => {
            await (0, sendRequest_1.default)(this, '09FF', 'chdown', 'channel down', IP, path);
        });
        this.registerCapabilityListener('volume_up', async () => {
            await (0, sendRequest_1.default)(this, '06FF', 'volup', 'volume up', IP, path);
        });
        this.registerCapabilityListener('volume_down', async () => {
            await (0, sendRequest_1.default)(this, '07FF', 'voldown', 'volume down', IP, path);
        });
        this.registerCapabilityListener('volume_mute', async () => {
            await (0, sendRequest_1.default)(this, '05FF', 'mute', 'volume mute', IP, path);
        });
        this.registerCapabilityListener('arrow_up_btn', async () => {
            await (0, sendRequest_1.default)(this, '0C02', 'cursor', 'arrow up', IP, path);
        });
        this.registerCapabilityListener('arrow_down_btn', async () => {
            await (0, sendRequest_1.default)(this, '0C04', 'cursor', 'arrow down', IP, path);
        });
        this.registerCapabilityListener('arrow_left_btn', async () => {
            await (0, sendRequest_1.default)(this, '0C01', 'cursor', 'arrow left', IP, path);
        });
        this.registerCapabilityListener('arrow_right_btn', async () => {
            await (0, sendRequest_1.default)(this, '0C03', 'cursor', 'arrow right', IP, path);
        });
        this.registerCapabilityListener('select_btn', async () => {
            await (0, sendRequest_1.default)(this, '0C00', 'cursor', 'cursor select', IP, path);
        });
        this.registerCapabilityListener('menu_btn', async () => {
            await (0, sendRequest_1.default)(this, '0DFF', 'menu', 'menu', IP, path);
        });
